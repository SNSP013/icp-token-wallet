  ...
  "../../node_modules/borc/node_modules/buffer/index.js"(exports) {
    ...
    Buffer.prototype.fill = function fill(val, start, end, encoding) {
      ...
      if (typeof val === "number") {
        ...
        var bytes2 = Buffer.isBuffer(val) ? val : Buffer.from(val, encoding);
...
function twistedEdwards(curveDef) {
  ...
  class Point {
    ...
    toRawBytes() {
      ...
      bytes2[bytes2.length - 1] |= x & _1n8 ? 128 : 0;
      return bytes2;
    }
    toHex() {
...
`);
  ...
  async syncTime(canisterId) {
    const CanisterStatus = await import("./canisterStatus-64K5KG2L.js");
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-EOHFGV4V.js.map
